...
<section>
    ...
    <form method="post" action="appointments.php">
        ...
        <input type="text" id="CounselorID" name="CounselorID" required><br><br>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['insert'])) {
        $stmt = $connection->prepare("INSERT INTO appointments (AppointmentID, ClientID, CounselorID,AppointmentDate,AppointmentTime) VALUES (?, ?, ?,?,?)");
        $stmt->bind_param("issss", $AID, $CID, $COID,$ADATE,$ATIME);
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                    ...
                    <td><a href='delete_appointments.php?AppointmentID={$row["AppointmentID"]}'>Delete</a></td> 
                    <td><a href='update_appointments.php?AppointmentID={$row["AppointmentID"]}'>Update</a></td> 
                </tr>";
            }
        } else {
